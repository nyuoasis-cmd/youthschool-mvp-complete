...
const step2Schema = z.object({
  ...
  department: z.string().min(1, "담당 부서를 입력해주세요"),
});
...
export default function SignupSchoolAdmin() {
  ...
  const step2Form = useForm<Step2Data>({
    ...
    defaultValues: { schoolName: "", schoolAddress: "", position: "", department: "" },
  });
        ...
        <form onSubmit={step2Form.handleSubmit(onStep2Submit)} className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="schoolName" type="text" placeholder="서울고등학교" className="pl-10" {...step2Form.register("schoolName")} />
            </div>
            {step2Form.formState.errors.schoolName && <p className="text-sm text-red-600">{step2Form.formState.errors.schoolName.message}</p>}
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="schoolAddress" type="text" placeholder="서울특별시 강남구 테헤란로 123" className="pl-10" {...step2Form.register("schoolAddress")} />
            </div>
            {step2Form.formState.errors.schoolAddress && <p className="text-sm text-red-600">{step2Form.formState.errors.schoolAddress.message}</p>}
          </div>

          <div className="space-y-2">
            <Label htmlFor="position">직위 *</Label>
            <Select value={step2Form.watch("position") || ""} onValueChange={(value) => step2Form.setValue("position", value)}>
              <SelectTrigger>
            ...
            {step2Form.formState.errors.position && <p className="text-sm text-red-600">{step2Form.formState.errors.position.message}</p>}
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="department" type="text" placeholder="학생지원부" className="pl-10" {...step2Form.register("department")} />
            </div>
            {step2Form.formState.errors.department && <p className="text-sm text-red-600">{step2Form.formState.errors.department.message}</p>}
          </div>

          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <p className="text-sm text-yellow-800">
              <strong>안내:</strong> 학교 관리자 계정은 시스템 관리자의 승인이 필요합니다.
              가입 완료 후 승인까지 1~2 영업일이 소요될 수 있습니다.
            </p>
          </div>
