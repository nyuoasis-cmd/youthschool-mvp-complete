...
- 수능/모의평가 표준 시간표:
  ...
  * 2교시: 수학 (10:30~12:10, 100분, 30문항, 공통+선택)
  * 3교시: 영어 (13:10~14:20, 70분, 45문항)
  * 4교시: 한국사/탐구 (14:50~16:32, 한국사 30분+탐구 각 30분)
  * 5교시: 제2외국어/한문 (17:00~17:40, 40분, 30문항)

[출력 형식]
아래 JSON 배열만 출력하세요. 코드블록/설명 텍스트 금지:
[
  {"period":"1교시","subject":"국어","time":"08:40~10:00 (80분)","questions":"45","note":""},
  {"period":"2교시","subject":"수학","time":"10:30~12:10 (100분)","questions":"30","note":"공통+선택"},
  {"period":"점심","subject":"점심시간","time":"12:10~13:10 (60분)","questions":"-","note":"외출 금지"},
  {"period":"3교시","subject":"영어","time":"13:10~14:20 (70분)","questions":"45","note":""},
  {"period":"4교시","subject":"한국사/탐구","time":"14:50~16:32","questions":"20/과목당 20","note":"한국사 필수"},
  {"period":"5교시","subject":"제2외국어/한문","time":"17:00~17:40 (40분)","questions":"30","note":"선택"}
]`;
...
[출력 형식]
아래 JSON 배열만 출력하세요. 코드블록/설명 텍스트 금지:
["신분증 (주민등록증, 여권, 학생증 등)","수험표","검은색 컴퓨터용 사인펜 (여분 포함)","수정테이프","샤프 또는 연필 (계산용)","지우개","아날로그 시계 (통신 기능 없는 것만 허용)"]`;
...
- 한국교육과정평가원 공식 기준
- 1교시: 08:10까지 입실 완료
- 2~5교시: 시험 시작 10분 전까지 입실 완료
- 지각 시 해당 교시 응시 불가

[출력 형식]
아래 JSON 객체만 출력하세요. 코드블록/설명 텍스트 금지:
{"entryTimeFirst":"08:10까지","entryTimeOthers":"시험 시작 10분 전까지"}`;
        } else if (fieldName === "additionalNotes") {
          prompt = `당신은 고등학교 교무부 담당 교사입니다.
...
[출력 형식]
아래 JSON 배열만 출력하세요. 코드블록/설명 텍스트 금지:
["점심 도시락을 지참하시기 바랍니다. (당일 급식 미운영)","시험 당일 편안한 복장으로 등교하세요.","대중교통 지연을 대비하여 여유있게 등교하시기 바랍니다.","시험 종료 후 바로 귀가하며, 별도 안내가 있을 시 공지합니다."]`;
        }
